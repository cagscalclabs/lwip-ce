 ...
 * Description: HMAC-based Key Derivation Function (HKDF) - RFC 5869 HKDF is used in TLS
 *              1.3 for all key derivation operations.
...
#ifndef LWIP_PUBLIC_CRYPTOGRAPHY_HKDF_H
#define LWIP_PUBLIC_CRYPTOGRAPHY_HKDF_H
...
#endif /* LWIP_PUBLIC_CRYPTOGRAPHY_HKDF_H */
