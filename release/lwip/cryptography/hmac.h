 ...
 * Description: Initializes an HMAC context to the the specified hash algorithm.
 * Generated: 2026-05-26T14:35:23Z
 */
#ifndef LWIP_PUBLIC_CRYPTOGRAPHY_HMAC_H
#define LWIP_PUBLIC_CRYPTOGRAPHY_HMAC_H
