...
static bool test_encode_unreserved(void)
{
    ...
    return n != (size_t)-1 && strcmp(buf, "hello-world_1.0~") == 0;
}
...
static bool test_encode_oauth_value(void)
{
    ...
    return n != (size_t)-1
        && strcmp(buf, "s3cr3t%2Bk3y%2Fv1%3Dabc%26xyz") == 0;
}
...
static bool test_decode_roundtrip(void)
{
    ...
    return n != (size_t)-1 && strcmp(buf, "s3cr3t+k3y/v1=abc&xyz") == 0;
}
...
static bool test_decode_plain(void)
{
    ...
    return n != (size_t)-1 && strcmp(buf, "hello") == 0;
}
