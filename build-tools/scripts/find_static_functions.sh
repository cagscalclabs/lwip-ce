#!/bin/bash
# build-tools/scripts/find_static_functions.sh — list non-static functions in a .c that are
# never referenced from any other TU.
#
# Usage: build-tools/scripts/find_static_functions.sh src/tls/core/aes.c
#
