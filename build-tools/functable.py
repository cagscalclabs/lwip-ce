...
Run from repo root:
    make functable
or directly:
    python3 build-tools/functable.py
"""
...
def render_functable(entries: list[str], origins: dict[str, str]) -> str:
    ...
    lines = [
        "; Auto-generated by build-tools/functable.py.  Do not edit by hand —",
...
def render_libload_stub(entries: list[str]) -> str:
    ...
    lines = [
        ...
        f"; Author: {author}",
        "; Do not edit by hand. Sources: build-tools/functable.py,",
        "; build-tools/lwip_init_runtime.asm.",
        "",
    ...
    # Append the hand-written bootstrap (build-tools/lwip_init_runtime.asm)
